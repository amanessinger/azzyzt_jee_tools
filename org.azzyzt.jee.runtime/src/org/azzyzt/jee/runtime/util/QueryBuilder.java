...
/**
 * Uses a JPA criteria builder to create a typed query equivalent to a <code>QuerySpec</code>. 
 ...
 * can be followed.
 *
 * @param <ID> Type of the ID of the entity class of the query result
 * @param <T> Type of the entity class or the query result
 * 
 * @see QuerySpec
 * @see EntityBase
 */
public class QueryBuilder <ID, T extends EntityBase<ID>> {
	...
	/**
	 * @param em a JPA <code>EntityManager</code>
	 * @param qs a query specification
	 * @param clazz the class of the resulting entities 
