...
public class CrudServiceRESTFullInterfaceModelBuilder extends DerivedModelBuilder implements Builder {

	public static final String INTERFACE_SUFFIX = "FullCxfRestInterface";

	public CrudServiceRESTFullInterfaceModelBuilder(MetaModel entityModel, String targetPackageName) {
	...
	public MetaModel build() {
		...
		for (MetaEntity me : masterModel.getTargetEntities()) {
			...
			me.setProperty(ModelProperties.REST_FULL_CXF_INTERFACE, target);
